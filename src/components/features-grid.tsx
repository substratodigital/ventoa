    ...
    <section className="py-20 px-6 md:px-12 bg-[#F2F2F2]/60">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/3 flex flex-col gap-4">
          <h2 className="text-[2rem] md:text-[3rem] font-bold font-heading tracking-tighter text-[#1A2B47] leading-tight">
            Por que terceirizar sua gestão financeira?
          </h2>
          <p className="text-[1rem] text-[#4D4D4D] font-lora mt-2">
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-4 w-full mb-1">
                    <div className="p-2.5 rounded-full bg-[#1A2B47]/5 group-hover:bg-[#00AEEF]/10 transition-colors shrink-0">
                      <Icon className="w-5 h-5 text-[#1A2B47] group-hover:text-[#00AEEF] transition-colors" />
                    </div>
                  </div>
                  <CardTitle className="text-[1.125rem] font-heading font-bold tracking-tight text-[#1A2B47] leading-tight">
                    {feature.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="pt-0 flex-1 flex flex-col justify-start">
                  <p className="text-[0.9375rem] font-lora text-[#4D4D4D] leading-relaxed">
                    {feature.text}
                  </p>
                </CardContent>
              </Card>
